...
TODO: Attention: Pour compiler avec g++, Iterator doit déclarer ConstIterator friend
afin que ConstIterator puisse avoir accès au constructeur privé pour implémenter la
...
TODO: Templates (SList4): operator==/!= en tant que friends -> selon g++, il faut les déclarer sous forme
de templates (voir aussi http://msdn.microsoft.com/en-us/library/f1b2td24.aspx). Ne linke ni
sous VC++ ni sous g++ sinon!
Alternative (à présenter): plus des friends mais des membres publics. Discuter des conséquences
éventuelles (y en a-t-il sur les conversions auto notamment?)
